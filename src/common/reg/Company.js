                ...
                <div className="reg-wrapper">
                    <div class="reg-cell">
                        <div className="reg-640">
                            <div className="r-title mb-20">创建响创意机构号</div>
                            <div className="r-txt mb-60">
                                USEIDEA响创意，记录创造者的洞见。<br />
                                发掘驱动创作的思考，定义以人为尺度的创意社区。
                                    </div>
                            <div class="reg-section">
                                <div class="r-lable mb-30">创建帐号，记录创作灵感</div>
                                ...
                                <div className="r-agree f-right mb-30">
                                    <p>
                                ...
                                <div className="r-right-txt">
                                    已有账户，<a href="/#/LoginQy" className="">立即登录</a>
                                </div>
                            </div>
                        </div>
                    </div>
