    ...
    createList = (name) => {
        ...
        return [<List
            ...
            renderItem={item => (
                ...
                >
                    <List.Item.Meta
                        avatar={<img width={242} alt="logo" src={banner1} />}
                        title={<a href={item.href}>{item.title}</a>}
                        description={[
                            <span>今天09:32</span>,
                            <p>Brand:Sony 索尼</p>,
                            <div className="action action-brand"><Icon type="gitlab" theme="filled" className="brand-icon" />企业名称</div>, <div className="action action-tool"><IconText type="heart" text="156" /><Divider type="vertical" /><IconText type="like-o" text="156" /><Divider type="vertical" /><IconText type="message" text="2" /></div>
                        ]}
                    />
                    {/* {item.content} */}
                </List.Item>
        ...
        />,
        <img src={banner4} style={{ marginBottom: 30 }} />
            ,
        <List
            itemLayout="vertical"
            dataSource={listData}
    ...
    render() {
        ...
        const content = (
            <div className="userinfo">
                ...
                />
                <p className="ant-list" style={{ paddingTop: 5 }}><span style={{ verticalAlign: 'middle', marginRight: 6 }}>来信</span><Badge count={25} /></p>
                <div className="logout"><Icon type="poweroff" /><span style={{ verticalAlign: 'middle' }}>退出</span></div>
            </div>
        );
                            ...
                            <ul className="rank-list">
                                ...
                                <List
                                    ...
                                    renderItem={(item, i) => (
                                        <List.Item>
                                            <List.Item.Meta
                                                avatar={<img shape="square" height={65} src="https://gw.alipayobjects.com/zos/rmsportal/mqaQswcyDLcXyDKnZfES.png" />}
                                                title={<a href="">{item.title}</a>}
                                                description="作者名称"
                                            />
